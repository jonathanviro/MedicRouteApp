...
object MoveAnimation {
    fun animar(
        objetoMarker: Marker, googleMap: GoogleMap, startPosition: LatLng,
        ...
        valueAnimator.addUpdateListener { valueAnimator ->
            ...
            objetoMarker.position = newPos
            objetoMarker.setAnchor(0.5f, 0.5f)
            objetoMarker.rotation = bearingBetweenLocations(startPosition, endPosition)
                .toFloat()
            if (callback != null) {
    ...
    fun animar(marker: Marker, start: LatLng, end: LatLng) {
        val valueAnimator = ValueAnimator.ofFloat(0f, 1f)
